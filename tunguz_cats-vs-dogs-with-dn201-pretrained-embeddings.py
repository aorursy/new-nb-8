...
target
train_DenseNet201 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_2/train_DenseNet201.npy')

test_DenseNet201 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_2/test_DenseNet201.npy')
train_DenseNet201.shape
X_train, X_val, y_train, y_val = train_test_split(train_DenseNet201, target, test_size=0.1, random_state=42)
...
test_preds = lr.predict_proba(test_DenseNet201)[:,1]
test_preds
