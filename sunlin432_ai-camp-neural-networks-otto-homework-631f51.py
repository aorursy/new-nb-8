...
data = pd.read_csv('C:\\Users\\Mandy\\Documents\\Chris datasets\\Neutral Networks\\train.csv')
...
model.score(X,y)
sum(pred == y) / len(y)
test_data = pd.read_csv('C:\\Users\\Mandy\\Documents\\Chris datasets\\Neutral Networks\\test.csv')
...
solution.to_csv('C:\\Users\\Mandy\\Documents\\Chris datasets\\Neutral Networks\\otto_prediction.tsv', index = False)
cols