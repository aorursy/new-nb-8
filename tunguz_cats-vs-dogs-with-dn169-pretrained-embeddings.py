...
target
train_DenseNet169 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_2/train_DenseNet169.npy')

test_DenseNet169 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_2/test_DenseNet169.npy')
train_DenseNet169.shape
X_train, X_val, y_train, y_val = train_test_split(train_DenseNet169, target, test_size=0.1, random_state=42)
...
test_preds = lr.predict_proba(test_DenseNet169)[:,1]
test_preds
