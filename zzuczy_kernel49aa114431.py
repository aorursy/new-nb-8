...
len(t_q_title_len)
train_text = [[q_input, q_input_mask, q_segment_mask, a_input, a_input_mask, a_segment_mask]\
...
train_num[0]
test_text = [[t_q_input, t_q_input_mask, t_q_segment_mask, t_a_input, t_a_input_mask, t_a_segment_mask] \
