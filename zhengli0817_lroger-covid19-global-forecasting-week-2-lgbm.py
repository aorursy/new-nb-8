...
def do_aggregation(df, col, mean_range, method='mean'):
...
print(hdi_cols)
# df_lat_long = pd.concat( [ pd.read_csv("../input/covid19-global-forecasting-week-1/train.csv"), pd.read_csv("../input/covid19-global-forecasting-week-2/test.csv") ] )
...
important_features = list(tmp[0:20]['feature'])
...
important_features = list(tmp[0:15]['feature'])
