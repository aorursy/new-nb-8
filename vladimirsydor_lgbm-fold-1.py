...
X_train = reduce_mem_usage(pd.read_parquet('/kaggle/input/baseline-preprocessing/X_train.parquet.gzip'))

X_test = reduce_mem_usage(pd.read_parquet('/kaggle/input/baseline-preprocessing/X_test.parquet.gzip'))
