...
Xtrain = hstack((Xtr_app, Xtr_label), format='csr')

Xtest =  hstack((Xte_app, Xte_label), format='csr')
...
#for i in range(150, 211, 20):

i=400

j = 10

rdf = RandomForestClassifier(n_estimators=i, max_depth=None, max_features=19729,
...
print(log_loss(y[70000:], pred),'est:',i,'split:',j)
pred = rdf.predict_proba(Xtrain[70000:])
