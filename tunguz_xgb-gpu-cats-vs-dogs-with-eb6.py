...
target
train_EB6 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_3/cats_and_dogs_3/train_EB6.npy')

test_EB6 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_3/cats_and_dogs_3/test_EB6.npy')
train_EB6.shape
X_train, X_val, y_train, y_val = train_test_split(train_EB6, target, test_size=0.1, random_state=42)
xgb_params = {
...
dtest = xgb.DMatrix(test_EB6)
del train_EB6, test_EB6, X_train, X_val
