...
target
train_VGG16 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_1/train_VGG16.npy')

test_VGG16 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_1/test_VGG16.npy')
train_VGG16.shape
X_train, X_val, y_train, y_val = train_test_split(train_VGG16, target, test_size=0.1, random_state=42)
...
test_preds = lr.predict_proba(test_VGG16)[:,1]
test_preds
