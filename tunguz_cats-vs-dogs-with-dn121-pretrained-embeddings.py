...
target
train_DenseNet121 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_2/train_DenseNet121.npy')

test_DenseNet121 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_2/test_DenseNet121.npy')
train_DenseNet121.shape
X_train, X_val, y_train, y_val = train_test_split(train_DenseNet121, target, test_size=0.1, random_state=42)

lr = LogisticRegression(C=0.002, max_iter=10000)
...
test_preds = lr.predict_proba(test_DenseNet121)[:,1]
test_preds
