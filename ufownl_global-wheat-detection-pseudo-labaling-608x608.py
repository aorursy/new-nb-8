...
def load_dataset(root, path=None):
...
model = load_model("/kaggle/input/global-wheat-detection-private/global-wheat-yolo3-darknet53_608x608_clean.params", ctx=context)



print("Loading training set...")

dataset = load_dataset("/kaggle/input/global-wheat-detection", "/kaggle/input/global-wheat-detection-clean/train_clean.csv")
