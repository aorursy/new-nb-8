...
for poly in train_polygons_scaled:
    ...
    xlist.append(np.count_nonzero(x))

    ylist.append(np.count_nonzero(y))
...
def mask_for_polygons(polygons):
    ...
    return img_mask, exteriors, interiors



train_mask, exteriors, interiors = mask_for_polygons(train_polygons_scaled)
len(exteriors)
len(interiors)
print(interiors)
