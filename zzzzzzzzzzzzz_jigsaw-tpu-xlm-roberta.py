...
validation = valid.copy().drop(columns=['comment_text','lang'])
validation['toxic'] = model.predict(valid_dataset, verbose=1)
validation.to_csv('jigsaw_tpu_xlm_roberta_submission_val.csv', index=False)
from sklearn.metrics import roc_auc_score
print(roc_auc_score(valid['toxic'], validation['toxic']))
