...
train['lag_4_ConfirmedCases']=train_lag_4['ConfirmedCases']

train['lag_4_Fatalities']=train_lag_4['Fatalities']
...
Fatalities_all_result_final['best_pred']=np.where(Fatalities_all_result_final['best_pred'] is np.nan , 0 , Fatalities_all_result_final['best_pred'] )

ConfirmedCases_all_result_Final['best_pred']=np.where(ConfirmedCases_all_result_Final['best_pred'] <0 , 0, ConfirmedCases_all_result_Final['best_pred'] )

Fatalities_all_result_final['best_pred']=np.where(Fatalities_all_result_final['best_pred'] <0 , 0 , Fatalities_all_result_final['best_pred'] )

ConfirmedCases_all_result_Final['best_pred_1']=np.where(ConfirmedCases_all_result_Final['AdditiveDamped'] is np.nan , ConfirmedCases_all_result_Final['best_pred'] , ConfirmedCases_all_result_Final['AdditiveDamped'] )

Fatalities_all_result_final['best_pred_1']=np.where(Fatalities_all_result_final['AdditiveDamped'] is np.nan , Fatalities_all_result_final['best_pred'] , Fatalities_all_result_final['AdditiveDamped'] )

ConfirmedCases_all_result_Final['best_pred_1']=np.where(ConfirmedCases_all_result_Final['best_pred'] is np.nan , 0, ConfirmedCases_all_result_Final['best_pred'] )

Fatalities_all_result_final['best_pred_1']=np.where(Fatalities_all_result_final['best_pred'] is np.nan , 0 , Fatalities_all_result_final['best_pred'] )

ConfirmedCases_all_result_Final['best_pred_1']=np.where(ConfirmedCases_all_result_Final['best_pred'] <0 , 0, ConfirmedCases_all_result_Final['best_pred'] )

Fatalities_all_result_final['best_pred_1']=np.where(Fatalities_all_result_final['best_pred'] <0 , 0 , Fatalities_all_result_final['best_pred'] )
