...
target
train_ResNet50 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_1/train_ResNet50.npy')

test_ResNet50 = np.load('../input/cats-and-dogs-embedded-data/cats_and_dogs_1/test_ResNet50.npy')
train_ResNet50.shape
X_train, X_val, y_train, y_val = train_test_split(train_ResNet50, target, test_size=0.1, random_state=42)
...
test_preds = lr.predict_proba(test_ResNet50)[:,1]
test_preds
