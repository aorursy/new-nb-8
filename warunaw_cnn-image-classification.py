...
for train_index, test_index in kf.split(X):
    ...
    cnn_model.add(Conv2D(32, kernel_size=(3, 3), activation='relu', input_shape=(train_avg_shape,train_avg_shape,3)))
...
for train_index, test_index in kf.split(X):
    ...
    cnn_model.add(Conv2D(32, kernel_size=(3, 3), activation='tanh', input_shape=(train_avg_shape,train_avg_shape,3)))
    ...
    cnn_model.add(Conv2D(64, kernel_size=(3, 3), activation='tanh'))
    ...
    cnn_model.add(Conv2D(128, kernel_size=(3, 3), activation='tanh'))
...
for train_index, test_index in kf.split(X):
    ...
    cnn_model.add(Conv2D(32, kernel_size=(2, 2), activation='relu', input_shape=(train_avg_shape,train_avg_shape,3)))
...
plt.legend(['Vallidation','Train'], loc='upper right')
...
for train_index, test_index in kf.split(X):
    ...
    cnn_model.add(Conv2D(64, kernel_size=(4, 4), activation='relu', input_shape=(train_avg_shape,train_avg_shape,3)))
    ...
    cnn_model.add(Conv2D(256, kernel_size=(4, 4), activation='relu'))
